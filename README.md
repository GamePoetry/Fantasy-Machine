...
This is a highly entertaining interactive game, but even more so, it is a poetry anthology in an entirely new form.The Normal Mode features over 90 ultra-short sci-fi poems, while the Collage Poetry Mode allows for infinite free combinations, enabling players to sign their saved creations as co-authors.

In Normal Mode, refine a Poetry Crystal by correctly selecting and ordering the Poetry Ores (three or four in total) from a poem. In Collage Poetry Mode, refine a Poetry Crystal by combining any three or four Poetry Ores.
...
在正常模式下，将一首诗中的诗歌矿石（包括三或四个）正确选中并正确排序来提炼诗歌晶体。在拼贴诗模式下，将任意三或四个诗歌矿石组合来提炼诗歌晶体。
